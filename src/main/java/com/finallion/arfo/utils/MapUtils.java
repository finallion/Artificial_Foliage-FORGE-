...
public class MapUtils {
    ...
    public static Map<Block, List<Block>> initMap(Map<Block, List<Block>> grassFeatures) {
        ...
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ANCIENT_FOREST_GRASS_BLOCK, GrassFeatures.ancient_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ARAUCARIA_SAVANNA_GRASS_BLOCK, GrassFeatures.araucaria_savanna);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ASPEN_FOREST_GRASS_BLOCK, GrassFeatures.aspen_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_AUTUMNAL_VALLEY_GRASS_BLOCK, GrassFeatures.autumnal_valley);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BASALT_BARRERA_GRASS_BLOCK, GrassFeatures.basalt_barrera);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BAYOU_GRASS_BLOCK, GrassFeatures.bayou);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BLUFF_STEEPS_GRASS_BLOCK, GrassFeatures.bluff_steeps);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_GRASS_BLOCK, GrassFeatures.cherry_blossom_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CIKA_WOODS_GRASS_BLOCK, GrassFeatures.cika_woods);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_COLD_SWAMPLANDS_GRASS_BLOCK, GrassFeatures.cold_swamplands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CONIFEROUS_FOREST_GRASS_BLOCK, GrassFeatures.byg_coniferous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRAG_GARDENS_GRASS_BLOCK, GrassFeatures.crag_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRIMSON_GARDENS_GRASS_BLOCK, GrassFeatures.crimson_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CYPRESS_SWAMPLAND_GRASS_BLOCK, GrassFeatures.cypress_swampland);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_DECIDUOUS_FOREST_GRASS_BLOCK, GrassFeatures.deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ENCHANTED_FOREST_GRASS_BLOCK, GrassFeatures.enchanted_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_FRESH_WATER_LAKE_GRASS_BLOCK, GrassFeatures.fresh_water_lake);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GLOWSTONE_GARDENS_GRASS_BLOCK, GrassFeatures.glowstone_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GRASS_LAND_PLATEAU_GRASS_BLOCK, GrassFeatures.grass_land_plateau);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GREAT_LAKES_GRASS_BLOCK, GrassFeatures.great_lakes);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GROVE_GRASS_BLOCK, GrassFeatures.grove);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GUIANA_SHIELD_GRASS_BLOCK, GrassFeatures.guiana_shield);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_JACARANDA_FOREST_GRASS_BLOCK, GrassFeatures.jacaranda_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_LUSH_TUNDRA_GRASS_BLOCK, GrassFeatures.lush_tundra);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ORCHARD_GRASS_BLOCK, GrassFeatures.orchard);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_POLLUTED_LAKE_GRASS_BLOCK, GrassFeatures.polluted_lake);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_PRAIRIE_GRASS_BLOCK, GrassFeatures.prairie);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_OAK_FOREST_GRASS_BLOCK, GrassFeatures.red_oak_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_ROCK_MOUNTAINS_GRASS_BLOCK, GrassFeatures.red_rock_mountains);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_REDWOOD_TROPICS_GRASS_BLOCK, GrassFeatures.redwood_tropics);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ROSE_FIELDS_GRASS_BLOCK, GrassFeatures.rose_fields);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_GRASS_BLOCK, GrassFeatures.seasonal_deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SHRUB_LANDS_GRASS_BLOCK, GrassFeatures.shrub_lands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SKYRIS_HIGHLANDS_GRASS_BLOCK, GrassFeatures.skyris_highlands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_GRASS_BLOCK, GrassFeatures.snowy_deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SYTHIAN_TORRIDS_GRASS_BLOCK, GrassFeatures.sythian_torrids);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_TROPICAL_RAIN_FOREST_GRASS_BLOCK, GrassFeatures.tropical_rain_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_VOLCANO_GRASS_BLOCK, GrassFeatures.volcano);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WAILING_GARTH_GRASS_BLOCK, GrassFeatures.wailing_garth);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WEEPING_MIRE_GRASS_BLOCK, GrassFeatures.weeping_mire);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WITHERING_WOODS_GRASS_BLOCK, GrassFeatures.withering_woods);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WOODLANDS_GRASS_BLOCK, GrassFeatures.byg_woodlands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ZELKOVA_FOREST_GRASS_BLOCK, GrassFeatures.zelkova_forest);
        //glowing
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_ANCIENT_FOREST_GRASS_BLOCK, GrassFeatures.ancient_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_ARAUCARIA_SAVANNA_GRASS_BLOCK, GrassFeatures.araucaria_savanna);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_ASPEN_FOREST_GRASS_BLOCK, GrassFeatures.aspen_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_AUTUMNAL_VALLEY_GRASS_BLOCK, GrassFeatures.autumnal_valley);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_BASALT_BARRERA_GRASS_BLOCK, GrassFeatures.basalt_barrera);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_BAYOU_GRASS_BLOCK, GrassFeatures.bayou);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_BLUFF_STEEPS_GRASS_BLOCK, GrassFeatures.bluff_steeps);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_GRASS_BLOCK, GrassFeatures.cherry_blossom_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_CIKA_WOODS_GRASS_BLOCK, GrassFeatures.cika_woods);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_COLD_SWAMPLANDS_GRASS_BLOCK, GrassFeatures.cold_swamplands);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_CONIFEROUS_FOREST_GRASS_BLOCK, GrassFeatures.byg_coniferous_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_CRAG_GARDENS_GRASS_BLOCK, GrassFeatures.crag_gardens);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_CRIMSON_GARDENS_GRASS_BLOCK, GrassFeatures.crimson_gardens);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_CYPRESS_SWAMPLAND_GRASS_BLOCK, GrassFeatures.cypress_swampland);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_DECIDUOUS_FOREST_GRASS_BLOCK, GrassFeatures.deciduous_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_ENCHANTED_FOREST_GRASS_BLOCK, GrassFeatures.enchanted_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_FRESH_WATER_LAKE_GRASS_BLOCK, GrassFeatures.fresh_water_lake);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_GLOWSTONE_GARDENS_GRASS_BLOCK, GrassFeatures.glowstone_gardens);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_GRASS_LAND_PLATEAU_GRASS_BLOCK, GrassFeatures.grass_land_plateau);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_GREAT_LAKES_GRASS_BLOCK, GrassFeatures.great_lakes);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_GROVE_GRASS_BLOCK, GrassFeatures.grove);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_GUIANA_SHIELD_GRASS_BLOCK, GrassFeatures.guiana_shield);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_JACARANDA_FOREST_GRASS_BLOCK, GrassFeatures.jacaranda_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_LUSH_TUNDRA_GRASS_BLOCK, GrassFeatures.lush_tundra);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_ORCHARD_GRASS_BLOCK, GrassFeatures.orchard);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_POLLUTED_LAKE_GRASS_BLOCK, GrassFeatures.polluted_lake);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_PRAIRIE_GRASS_BLOCK, GrassFeatures.prairie);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_RED_OAK_FOREST_GRASS_BLOCK, GrassFeatures.red_oak_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_RED_ROCK_MOUNTAINS_GRASS_BLOCK, GrassFeatures.red_rock_mountains);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_REDWOOD_TROPICS_GRASS_BLOCK, GrassFeatures.redwood_tropics);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_ROSE_FIELDS_GRASS_BLOCK, GrassFeatures.rose_fields);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_GRASS_BLOCK, GrassFeatures.seasonal_deciduous_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_SHRUB_LANDS_GRASS_BLOCK, GrassFeatures.shrub_lands);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_SKYRIS_HIGHLANDS_GRASS_BLOCK, GrassFeatures.skyris_highlands);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_GRASS_BLOCK, GrassFeatures.snowy_deciduous_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_SYTHIAN_TORRIDS_GRASS_BLOCK, GrassFeatures.sythian_torrids);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_TROPICAL_RAIN_FOREST_GRASS_BLOCK, GrassFeatures.tropical_rain_forest);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_VOLCANO_GRASS_BLOCK, GrassFeatures.volcano);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_WAILING_GARTH_GRASS_BLOCK, GrassFeatures.wailing_garth);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_WEEPING_MIRE_GRASS_BLOCK, GrassFeatures.weeping_mire);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_WITHERING_WOODS_GRASS_BLOCK, GrassFeatures.withering_woods);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_WOODLANDS_GRASS_BLOCK, GrassFeatures.byg_woodlands);
        grassFeatures.put(BYGBlocks.GLOWING_BIOMESYOULLGO_ZELKOVA_FOREST_GRASS_BLOCK, GrassFeatures.zelkova_forest);
        //stone
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ANCIENT_FOREST_OVERGROWN_STONE, GrassFeatures.ancient_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ARAUCARIA_SAVANNA_OVERGROWN_STONE, GrassFeatures.araucaria_savanna);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ASPEN_FOREST_OVERGROWN_STONE, GrassFeatures.aspen_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_AUTUMNAL_VALLEY_OVERGROWN_STONE, GrassFeatures.autumnal_valley);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BASALT_BARRERA_OVERGROWN_STONE, GrassFeatures.basalt_barrera);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BAYOU_OVERGROWN_STONE, GrassFeatures.bayou);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BLUFF_STEEPS_OVERGROWN_STONE, GrassFeatures.bluff_steeps);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_OVERGROWN_STONE, GrassFeatures.cherry_blossom_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CIKA_WOODS_OVERGROWN_STONE, GrassFeatures.cika_woods);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_COLD_SWAMPLANDS_OVERGROWN_STONE, GrassFeatures.cold_swamplands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CONIFEROUS_FOREST_OVERGROWN_STONE, GrassFeatures.byg_coniferous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRAG_GARDENS_OVERGROWN_STONE, GrassFeatures.crag_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRIMSON_GARDENS_OVERGROWN_STONE, GrassFeatures.crimson_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CYPRESS_SWAMPLAND_OVERGROWN_STONE, GrassFeatures.cypress_swampland);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_DECIDUOUS_FOREST_OVERGROWN_STONE, GrassFeatures.deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ENCHANTED_FOREST_OVERGROWN_STONE, GrassFeatures.enchanted_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_FRESH_WATER_LAKE_OVERGROWN_STONE, GrassFeatures.fresh_water_lake);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GLOWSTONE_GARDENS_OVERGROWN_STONE, GrassFeatures.glowstone_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GRASS_LAND_PLATEAU_OVERGROWN_STONE, GrassFeatures.grass_land_plateau);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GREAT_LAKES_OVERGROWN_STONE, GrassFeatures.great_lakes);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GROVE_OVERGROWN_STONE, GrassFeatures.grove);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GUIANA_SHIELD_OVERGROWN_STONE, GrassFeatures.guiana_shield);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_JACARANDA_FOREST_OVERGROWN_STONE, GrassFeatures.jacaranda_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_LUSH_TUNDRA_OVERGROWN_STONE, GrassFeatures.lush_tundra);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ORCHARD_OVERGROWN_STONE, GrassFeatures.orchard);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_POLLUTED_LAKE_OVERGROWN_STONE, GrassFeatures.polluted_lake);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_PRAIRIE_OVERGROWN_STONE, GrassFeatures.prairie);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_OAK_FOREST_OVERGROWN_STONE, GrassFeatures.red_oak_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_ROCK_MOUNTAINS_OVERGROWN_STONE, GrassFeatures.red_rock_mountains);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_REDWOOD_TROPICS_OVERGROWN_STONE, GrassFeatures.redwood_tropics);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ROSE_FIELDS_OVERGROWN_STONE, GrassFeatures.rose_fields);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_OVERGROWN_STONE, GrassFeatures.seasonal_deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SHRUB_LANDS_OVERGROWN_STONE, GrassFeatures.shrub_lands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SKYRIS_HIGHLANDS_OVERGROWN_STONE, GrassFeatures.skyris_highlands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_OVERGROWN_STONE, GrassFeatures.snowy_deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SYTHIAN_TORRIDS_OVERGROWN_STONE, GrassFeatures.sythian_torrids);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_TROPICAL_RAIN_FOREST_OVERGROWN_STONE, GrassFeatures.tropical_rain_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_VOLCANO_OVERGROWN_STONE, GrassFeatures.volcano);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WAILING_GARTH_OVERGROWN_STONE, GrassFeatures.wailing_garth);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WEEPING_MIRE_OVERGROWN_STONE, GrassFeatures.weeping_mire);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WITHERING_WOODS_OVERGROWN_STONE, GrassFeatures.withering_woods);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WOODLANDS_OVERGROWN_STONE, GrassFeatures.byg_woodlands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ZELKOVA_FOREST_OVERGROWN_STONE, GrassFeatures.zelkova_forest);
        //dacite
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ANCIENT_FOREST_OVERGROWN_DACITE, GrassFeatures.ancient_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ARAUCARIA_SAVANNA_OVERGROWN_DACITE, GrassFeatures.araucaria_savanna);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ASPEN_FOREST_OVERGROWN_DACITE, GrassFeatures.aspen_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_AUTUMNAL_VALLEY_OVERGROWN_DACITE, GrassFeatures.autumnal_valley);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BASALT_BARRERA_OVERGROWN_DACITE, GrassFeatures.basalt_barrera);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BAYOU_OVERGROWN_DACITE, GrassFeatures.bayou);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BLUFF_STEEPS_OVERGROWN_DACITE, GrassFeatures.bluff_steeps);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_OVERGROWN_DACITE, GrassFeatures.cherry_blossom_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CIKA_WOODS_OVERGROWN_DACITE, GrassFeatures.cika_woods);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_COLD_SWAMPLANDS_OVERGROWN_DACITE, GrassFeatures.cold_swamplands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CONIFEROUS_FOREST_OVERGROWN_DACITE, GrassFeatures.byg_coniferous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRAG_GARDENS_OVERGROWN_DACITE, GrassFeatures.crag_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRIMSON_GARDENS_OVERGROWN_DACITE, GrassFeatures.crimson_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CYPRESS_SWAMPLAND_OVERGROWN_DACITE, GrassFeatures.cypress_swampland);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_DECIDUOUS_FOREST_OVERGROWN_DACITE, GrassFeatures.deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ENCHANTED_FOREST_OVERGROWN_DACITE, GrassFeatures.enchanted_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_FRESH_WATER_LAKE_OVERGROWN_DACITE, GrassFeatures.fresh_water_lake);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GLOWSTONE_GARDENS_OVERGROWN_DACITE, GrassFeatures.glowstone_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GRASS_LAND_PLATEAU_OVERGROWN_DACITE, GrassFeatures.grass_land_plateau);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GREAT_LAKES_OVERGROWN_DACITE, GrassFeatures.great_lakes);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GROVE_OVERGROWN_DACITE, GrassFeatures.grove);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GUIANA_SHIELD_OVERGROWN_DACITE, GrassFeatures.guiana_shield);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_JACARANDA_FOREST_OVERGROWN_DACITE, GrassFeatures.jacaranda_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_LUSH_TUNDRA_OVERGROWN_DACITE, GrassFeatures.lush_tundra);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ORCHARD_OVERGROWN_DACITE, GrassFeatures.orchard);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_POLLUTED_LAKE_OVERGROWN_DACITE, GrassFeatures.polluted_lake);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_PRAIRIE_OVERGROWN_DACITE, GrassFeatures.prairie);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_OAK_FOREST_OVERGROWN_DACITE, GrassFeatures.red_oak_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_ROCK_MOUNTAINS_OVERGROWN_DACITE, GrassFeatures.red_rock_mountains);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_REDWOOD_TROPICS_OVERGROWN_DACITE, GrassFeatures.redwood_tropics);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ROSE_FIELDS_OVERGROWN_DACITE, GrassFeatures.rose_fields);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_OVERGROWN_DACITE, GrassFeatures.seasonal_deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SHRUB_LANDS_OVERGROWN_DACITE, GrassFeatures.shrub_lands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SKYRIS_HIGHLANDS_OVERGROWN_DACITE, GrassFeatures.skyris_highlands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_OVERGROWN_DACITE, GrassFeatures.snowy_deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SYTHIAN_TORRIDS_OVERGROWN_DACITE, GrassFeatures.sythian_torrids);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_TROPICAL_RAIN_FOREST_OVERGROWN_DACITE, GrassFeatures.tropical_rain_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_VOLCANO_OVERGROWN_DACITE, GrassFeatures.volcano);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WAILING_GARTH_OVERGROWN_DACITE, GrassFeatures.wailing_garth);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WEEPING_MIRE_OVERGROWN_DACITE, GrassFeatures.weeping_mire);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WITHERING_WOODS_OVERGROWN_DACITE, GrassFeatures.withering_woods);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WOODLANDS_OVERGROWN_DACITE, GrassFeatures.byg_woodlands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ZELKOVA_FOREST_OVERGROWN_DACITE, GrassFeatures.zelkova_forest);
        //netherrack
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ANCIENT_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.ancient_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ARAUCARIA_SAVANNA_OVERGROWN_NETHERRACK, GrassFeatures.araucaria_savanna);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ASPEN_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.aspen_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_AUTUMNAL_VALLEY_OVERGROWN_NETHERRACK, GrassFeatures.autumnal_valley);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BASALT_BARRERA_OVERGROWN_NETHERRACK, GrassFeatures.basalt_barrera);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BAYOU_OVERGROWN_NETHERRACK, GrassFeatures.bayou);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BLUFF_STEEPS_OVERGROWN_NETHERRACK, GrassFeatures.bluff_steeps);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.cherry_blossom_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CIKA_WOODS_OVERGROWN_NETHERRACK, GrassFeatures.cika_woods);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_COLD_SWAMPLANDS_OVERGROWN_NETHERRACK, GrassFeatures.cold_swamplands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CONIFEROUS_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.byg_coniferous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRAG_GARDENS_OVERGROWN_NETHERRACK, GrassFeatures.crag_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRIMSON_GARDENS_OVERGROWN_NETHERRACK, GrassFeatures.crimson_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CYPRESS_SWAMPLAND_OVERGROWN_NETHERRACK, GrassFeatures.cypress_swampland);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_DECIDUOUS_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ENCHANTED_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.enchanted_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_FRESH_WATER_LAKE_OVERGROWN_NETHERRACK, GrassFeatures.fresh_water_lake);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GLOWSTONE_GARDENS_OVERGROWN_NETHERRACK, GrassFeatures.glowstone_gardens);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GRASS_LAND_PLATEAU_OVERGROWN_NETHERRACK, GrassFeatures.grass_land_plateau);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GREAT_LAKES_OVERGROWN_NETHERRACK, GrassFeatures.great_lakes);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GROVE_OVERGROWN_NETHERRACK, GrassFeatures.grove);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GUIANA_SHIELD_OVERGROWN_NETHERRACK, GrassFeatures.guiana_shield);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_JACARANDA_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.jacaranda_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_LUSH_TUNDRA_OVERGROWN_NETHERRACK, GrassFeatures.lush_tundra);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ORCHARD_OVERGROWN_NETHERRACK, GrassFeatures.orchard);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_POLLUTED_LAKE_OVERGROWN_NETHERRACK, GrassFeatures.polluted_lake);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_PRAIRIE_OVERGROWN_NETHERRACK, GrassFeatures.prairie);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_OAK_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.red_oak_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_ROCK_MOUNTAINS_OVERGROWN_NETHERRACK, GrassFeatures.red_rock_mountains);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_REDWOOD_TROPICS_OVERGROWN_NETHERRACK, GrassFeatures.redwood_tropics);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ROSE_FIELDS_OVERGROWN_NETHERRACK, GrassFeatures.rose_fields);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.seasonal_deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SHRUB_LANDS_OVERGROWN_NETHERRACK, GrassFeatures.shrub_lands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SKYRIS_HIGHLANDS_OVERGROWN_NETHERRACK, GrassFeatures.skyris_highlands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.snowy_deciduous_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SYTHIAN_TORRIDS_OVERGROWN_NETHERRACK, GrassFeatures.sythian_torrids);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_TROPICAL_RAIN_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.tropical_rain_forest);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_VOLCANO_OVERGROWN_NETHERRACK, GrassFeatures.volcano);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WAILING_GARTH_OVERGROWN_NETHERRACK, GrassFeatures.wailing_garth);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WEEPING_MIRE_OVERGROWN_NETHERRACK, GrassFeatures.weeping_mire);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WITHERING_WOODS_OVERGROWN_NETHERRACK, GrassFeatures.withering_woods);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WOODLANDS_OVERGROWN_NETHERRACK, GrassFeatures.byg_woodlands);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ZELKOVA_FOREST_OVERGROWN_NETHERRACK, GrassFeatures.zelkova_forest);
    ...
    public static Map<Block, Block> initFernMap(Map<Block, Block> grassFeatures) {
        ...
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ANCIENT_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_ANCIENT_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ARAUCARIA_SAVANNA_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_ARAUCARIA_SAVANNA_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ASPEN_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_ASPEN_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_AUTUMNAL_VALLEY_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_AUTUMNAL_VALLEY_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BASALT_BARRERA_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_BASALT_BARRERA_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BAYOU_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_BAYOU_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BLUFF_STEEPS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_BLUFF_STEEPS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CIKA_WOODS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_CIKA_WOODS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_COLD_SWAMPLANDS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_COLD_SWAMPLANDS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CONIFEROUS_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_CONIFEROUS_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRAG_GARDENS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_CRAG_GARDENS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRIMSON_GARDENS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_CRIMSON_GARDENS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CYPRESS_SWAMPLAND_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_CYPRESS_SWAMPLAND_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_DECIDUOUS_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_DECIDUOUS_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ENCHANTED_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_ENCHANTED_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_FRESH_WATER_LAKE_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_FRESH_WATER_LAKE_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GLOWSTONE_GARDENS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_GLOWSTONE_GARDENS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GRASS_LAND_PLATEAU_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_GRASS_LAND_PLATEAU_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GREAT_LAKES_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_GREAT_LAKES_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GROVE_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_GROVE_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GUIANA_SHIELD_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_GUIANA_SHIELD_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_JACARANDA_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_JACARANDA_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_LUSH_TUNDRA_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_LUSH_TUNDRA_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ORCHARD_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_ORCHARD_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_POLLUTED_LAKE_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_POLLUTED_LAKE_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_PRAIRIE_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_PRAIRIE_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_OAK_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_RED_OAK_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_ROCK_MOUNTAINS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_RED_ROCK_MOUNTAINS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_REDWOOD_TROPICS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_REDWOOD_TROPICS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ROSE_FIELDS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_ROSE_FIELDS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SHRUB_LANDS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_SHRUB_LANDS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SKYRIS_HIGHLANDS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_SKYRIS_HIGHLANDS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SYTHIAN_TORRIDS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_SYTHIAN_TORRIDS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_TROPICAL_RAIN_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_TROPICAL_RAIN_FOREST_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_VOLCANO_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_VOLCANO_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WAILING_GARTH_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_WAILING_GARTH_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WEEPING_MIRE_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_WEEPING_MIRE_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WITHERING_WOODS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_WITHERING_WOODS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WOODLANDS_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_WOODLANDS_FERN);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ZELKOVA_FOREST_FERN, BYGBlocks.LARGE_BIOMESYOULLGO_ZELKOVA_FOREST_FERN);
    ...
    public static Map<Block, Block> initGrassMap(Map<Block, Block> grassFeatures) {
        ...
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ANCIENT_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_ANCIENT_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ARAUCARIA_SAVANNA_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_ARAUCARIA_SAVANNA_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ASPEN_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_ASPEN_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_AUTUMNAL_VALLEY_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_AUTUMNAL_VALLEY_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BASALT_BARRERA_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_BASALT_BARRERA_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BAYOU_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_BAYOU_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_BLUFF_STEEPS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_BLUFF_STEEPS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_CHERRY_BLOSSOM_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CIKA_WOODS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_CIKA_WOODS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_COLD_SWAMPLANDS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_COLD_SWAMPLANDS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CONIFEROUS_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_CONIFEROUS_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRAG_GARDENS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_CRAG_GARDENS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CRIMSON_GARDENS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_CRIMSON_GARDENS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_CYPRESS_SWAMPLAND_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_CYPRESS_SWAMPLAND_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_DECIDUOUS_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_DECIDUOUS_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ENCHANTED_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_ENCHANTED_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_FRESH_WATER_LAKE_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_FRESH_WATER_LAKE_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GLOWSTONE_GARDENS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_GLOWSTONE_GARDENS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GRASS_LAND_PLATEAU_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_GRASS_LAND_PLATEAU_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GREAT_LAKES_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_GREAT_LAKES_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GROVE_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_GROVE_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_GUIANA_SHIELD_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_GUIANA_SHIELD_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_JACARANDA_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_JACARANDA_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_LUSH_TUNDRA_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_LUSH_TUNDRA_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ORCHARD_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_ORCHARD_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_POLLUTED_LAKE_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_POLLUTED_LAKE_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_PRAIRIE_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_PRAIRIE_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_OAK_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_RED_OAK_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_RED_ROCK_MOUNTAINS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_RED_ROCK_MOUNTAINS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_REDWOOD_TROPICS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_REDWOOD_TROPICS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ROSE_FIELDS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_ROSE_FIELDS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_SEASONAL_DECIDUOUS_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SHRUB_LANDS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_SHRUB_LANDS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SKYRIS_HIGHLANDS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_SKYRIS_HIGHLANDS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_SNOWY_DECIDUOUS_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_SYTHIAN_TORRIDS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_SYTHIAN_TORRIDS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_TROPICAL_RAIN_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_TROPICAL_RAIN_FOREST_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_VOLCANO_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_VOLCANO_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WAILING_GARTH_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_WAILING_GARTH_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WEEPING_MIRE_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_WEEPING_MIRE_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WITHERING_WOODS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_WITHERING_WOODS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_WOODLANDS_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_WOODLANDS_GRASS);
        grassFeatures.put(BYGBlocks.BIOMESYOULLGO_ZELKOVA_FOREST_GRASS, BYGBlocks.TALL_BIOMESYOULLGO_ZELKOVA_FOREST_GRASS);
