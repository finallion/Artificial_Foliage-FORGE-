...
public class ARFOItems {
    ...
    public static final Item MUSHROOM_FIELDS_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_STONE));
    public static final Item MUSHROOM_FIELDS_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_STONE_SLAB));
    public static final Item MUSHROOM_FIELDS_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_DACITE));
    public static final Item MUSHROOM_FIELDS_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_DACITE_SLAB));
    public static final Item MUSHROOM_FIELDS_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_NETHERRACK));
    public static final Item MUSHROOM_FIELDS_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MUSHROOM_FIELDS_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item JUNGLE_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_OVERGROWN_STONE));
    public static final Item JUNGLE_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_OVERGROWN_STONE_SLAB));
    public static final Item JUNGLE_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_OVERGROWN_DACITE));
    public static final Item JUNGLE_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_OVERGROWN_DACITE_SLAB));
    public static final Item JUNGLE_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_OVERGROWN_NETHERRACK));
    public static final Item JUNGLE_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item JUNGLE_EDGE_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_STONE));
    public static final Item JUNGLE_EDGE_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_STONE_SLAB));
    public static final Item JUNGLE_EDGE_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_DACITE));
    public static final Item JUNGLE_EDGE_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_DACITE_SLAB));
    public static final Item JUNGLE_EDGE_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_NETHERRACK));
    public static final Item JUNGLE_EDGE_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.JUNGLE_EDGE_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item FOREST_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.FOREST_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.FOREST_OVERGROWN_STONE));
    public static final Item FOREST_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.FOREST_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.FOREST_OVERGROWN_STONE_SLAB));
    public static final Item FOREST_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.FOREST_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.FOREST_OVERGROWN_DACITE));
    public static final Item FOREST_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.FOREST_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.FOREST_OVERGROWN_DACITE_SLAB));
    public static final Item FOREST_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.FOREST_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.FOREST_OVERGROWN_NETHERRACK));
    public static final Item FOREST_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.FOREST_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.FOREST_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item BIRCH_FOREST_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.BIRCH_FOREST_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BIRCH_FOREST_OVERGROWN_STONE));
    public static final Item BIRCH_FOREST_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.BIRCH_FOREST_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BIRCH_FOREST_OVERGROWN_STONE_SLAB));
    public static final Item BIRCH_FOREST_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.BIRCH_FOREST_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BIRCH_FOREST_OVERGROWN_DACITE));
    public static final Item BIRCH_FOREST_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.BIRCH_FOREST_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BIRCH_FOREST_OVERGROWN_DACITE_SLAB));
    public static final Item BIRCH_FOREST_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.BIRCH_FOREST_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BIRCH_FOREST_OVERGROWN_NETHERRACK));
    public static final Item BIRCH_FOREST_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.BIRCH_FOREST_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BIRCH_FOREST_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item PLAINS_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.PLAINS_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.PLAINS_OVERGROWN_STONE));
    public static final Item PLAINS_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.PLAINS_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.PLAINS_OVERGROWN_STONE_SLAB));
    public static final Item PLAINS_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.PLAINS_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.PLAINS_OVERGROWN_DACITE));
    public static final Item PLAINS_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.PLAINS_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.PLAINS_OVERGROWN_DACITE_SLAB));
    public static final Item PLAINS_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.PLAINS_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.PLAINS_OVERGROWN_NETHERRACK));
    public static final Item PLAINS_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.PLAINS_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.PLAINS_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item WATERS_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.WATERS_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.WATERS_OVERGROWN_STONE));
    public static final Item WATERS_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.WATERS_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.WATERS_OVERGROWN_STONE_SLAB));
    public static final Item WATERS_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.WATERS_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.WATERS_OVERGROWN_DACITE));
    public static final Item WATERS_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.WATERS_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.WATERS_OVERGROWN_DACITE_SLAB));
    public static final Item WATERS_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.WATERS_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.WATERS_OVERGROWN_NETHERRACK));
    public static final Item WATERS_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.WATERS_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.WATERS_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item MEGA_TAIGA_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.MEGA_TAIGA_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MEGA_TAIGA_OVERGROWN_STONE));
    public static final Item MEGA_TAIGA_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MEGA_TAIGA_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MEGA_TAIGA_OVERGROWN_STONE_SLAB));
    public static final Item MEGA_TAIGA_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.MEGA_TAIGA_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MEGA_TAIGA_OVERGROWN_DACITE));
    public static final Item MEGA_TAIGA_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MEGA_TAIGA_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MEGA_TAIGA_OVERGROWN_DACITE_SLAB));
    public static final Item MEGA_TAIGA_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.MEGA_TAIGA_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MEGA_TAIGA_OVERGROWN_NETHERRACK));
    public static final Item MEGA_TAIGA_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MEGA_TAIGA_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MEGA_TAIGA_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item TAIGA_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.TAIGA_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.TAIGA_OVERGROWN_STONE));
    public static final Item TAIGA_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.TAIGA_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.TAIGA_OVERGROWN_STONE_SLAB));
    public static final Item TAIGA_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.TAIGA_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.TAIGA_OVERGROWN_DACITE));
    public static final Item TAIGA_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.TAIGA_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.TAIGA_OVERGROWN_DACITE_SLAB));
    public static final Item TAIGA_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.TAIGA_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.TAIGA_OVERGROWN_NETHERRACK));
    public static final Item TAIGA_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.TAIGA_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.TAIGA_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item MOUNTAINS_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.MOUNTAINS_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MOUNTAINS_OVERGROWN_STONE));
    public static final Item MOUNTAINS_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MOUNTAINS_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MOUNTAINS_OVERGROWN_STONE_SLAB));
    public static final Item MOUNTAINS_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.MOUNTAINS_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MOUNTAINS_OVERGROWN_DACITE));
    public static final Item MOUNTAINS_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MOUNTAINS_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MOUNTAINS_OVERGROWN_DACITE_SLAB));
    public static final Item MOUNTAINS_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.MOUNTAINS_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MOUNTAINS_OVERGROWN_NETHERRACK));
    public static final Item MOUNTAINS_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.MOUNTAINS_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.MOUNTAINS_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item SNOWY_BEACH_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_BEACH_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_BEACH_OVERGROWN_STONE));
    public static final Item SNOWY_BEACH_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_BEACH_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_BEACH_OVERGROWN_STONE_SLAB));
    public static final Item SNOWY_BEACH_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_BEACH_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_BEACH_OVERGROWN_DACITE));
    public static final Item SNOWY_BEACH_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_BEACH_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_BEACH_OVERGROWN_DACITE_SLAB));
    public static final Item SNOWY_BEACH_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_BEACH_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_BEACH_OVERGROWN_NETHERRACK));
    public static final Item SNOWY_BEACH_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_BEACH_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_BEACH_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item SNOWY_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_OVERGROWN_STONE));
    public static final Item SNOWY_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_OVERGROWN_STONE_SLAB));
    public static final Item SNOWY_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_OVERGROWN_DACITE));
    public static final Item SNOWY_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_OVERGROWN_DACITE_SLAB));
    public static final Item SNOWY_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_OVERGROWN_NETHERRACK));
    public static final Item SNOWY_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SNOWY_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SNOWY_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item DARK_FOREST_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.DARK_FOREST_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.DARK_FOREST_OVERGROWN_STONE));
    public static final Item DARK_FOREST_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.DARK_FOREST_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.DARK_FOREST_OVERGROWN_STONE_SLAB));
    public static final Item DARK_FOREST_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.DARK_FOREST_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.DARK_FOREST_OVERGROWN_DACITE));
    public static final Item DARK_FOREST_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.DARK_FOREST_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.DARK_FOREST_OVERGROWN_DACITE_SLAB));
    public static final Item DARK_FOREST_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.DARK_FOREST_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.DARK_FOREST_OVERGROWN_NETHERRACK));
    public static final Item DARK_FOREST_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.DARK_FOREST_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.DARK_FOREST_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item LUSH_SWAMP_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.LUSH_SWAMP_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.LUSH_SWAMP_OVERGROWN_STONE));
    public static final Item LUSH_SWAMP_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.LUSH_SWAMP_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.LUSH_SWAMP_OVERGROWN_STONE_SLAB));
    public static final Item LUSH_SWAMP_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.LUSH_SWAMP_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.LUSH_SWAMP_OVERGROWN_DACITE));
    public static final Item LUSH_SWAMP_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.LUSH_SWAMP_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.LUSH_SWAMP_OVERGROWN_DACITE_SLAB));
    public static final Item LUSH_SWAMP_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.LUSH_SWAMP_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.LUSH_SWAMP_OVERGROWN_NETHERRACK));
    public static final Item LUSH_SWAMP_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.LUSH_SWAMP_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.LUSH_SWAMP_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item SWAMP_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.SWAMP_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SWAMP_OVERGROWN_STONE));
    public static final Item SWAMP_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SWAMP_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SWAMP_OVERGROWN_STONE_SLAB));
    public static final Item SWAMP_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.SWAMP_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SWAMP_OVERGROWN_DACITE));
    public static final Item SWAMP_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SWAMP_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SWAMP_OVERGROWN_DACITE_SLAB));
    public static final Item SWAMP_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.SWAMP_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SWAMP_OVERGROWN_NETHERRACK));
    public static final Item SWAMP_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SWAMP_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SWAMP_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item SAVANNA_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.SAVANNA_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SAVANNA_OVERGROWN_STONE));
    public static final Item SAVANNA_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SAVANNA_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SAVANNA_OVERGROWN_STONE_SLAB));
    public static final Item SAVANNA_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.SAVANNA_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SAVANNA_OVERGROWN_DACITE));
    public static final Item SAVANNA_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SAVANNA_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SAVANNA_OVERGROWN_DACITE_SLAB));
    public static final Item SAVANNA_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.SAVANNA_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SAVANNA_OVERGROWN_NETHERRACK));
    public static final Item SAVANNA_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.SAVANNA_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.SAVANNA_OVERGROWN_NETHERRACK_SLAB));
    ...
    public static final Item BADLANDS_OVERGROWN_STONE = ARFOItems.createItem(new BlockItem(ARFOBlocks.BADLANDS_OVERGROWN_STONE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BADLANDS_OVERGROWN_STONE));
    public static final Item BADLANDS_OVERGROWN_STONE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.BADLANDS_OVERGROWN_STONE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BADLANDS_OVERGROWN_STONE_SLAB));
    public static final Item BADLANDS_OVERGROWN_DACITE = ARFOItems.createItem(new BlockItem(ARFOBlocks.BADLANDS_OVERGROWN_DACITE, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BADLANDS_OVERGROWN_DACITE));
    public static final Item BADLANDS_OVERGROWN_DACITE_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.BADLANDS_OVERGROWN_DACITE_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BADLANDS_OVERGROWN_DACITE_SLAB));
    public static final Item BADLANDS_OVERGROWN_NETHERRACK = ARFOItems.createItem(new BlockItem(ARFOBlocks.BADLANDS_OVERGROWN_NETHERRACK, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BADLANDS_OVERGROWN_NETHERRACK));
    public static final Item BADLANDS_OVERGROWN_NETHERRACK_SLAB = ARFOItems.createItem(new BlockItem(ARFOBlocks.BADLANDS_OVERGROWN_NETHERRACK_SLAB, new Item.Properties().tab(ArtificialFoliage.itemGroup)), Registry.BLOCK.getKey(ARFOBlocks.BADLANDS_OVERGROWN_NETHERRACK_SLAB));
