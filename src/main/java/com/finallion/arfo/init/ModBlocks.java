...
public class ModBlocks {
    ...
    public static final Block COLD_OCEAN_WATER = createFluidBlock(ModFluids.STILL_COLD_OCEAN_WATER, "cold_ocean_water");
    public static final Block FROZEN_OCEAN_WATER = createFluidBlock(ModFluids.STILL_FROZEN_OCEAN_WATER, "frozen_ocean_water");
    public static final Block LUKEWARM_OCEAN_WATER = createFluidBlock(ModFluids.STILL_LUKEWARM_OCEAN_WATER, "lukewarm_ocean_water");
    public static final Block WARM_OCEAN_WATER = createFluidBlock(ModFluids.STILL_WARM_OCEAN_WATER, "warm_ocean_water");
    public static final Block SWAMP_WATER = createFluidBlock(ModFluids.STILL_SWAMP_WATER, "swamp_water");
    public static final Block OCEAN_WATER = createFluidBlock(ModFluids.STILL_OCEAN_WATER, "ocean_water");
