...
public abstract class BopOriginValleyWater extends ARFOWater {

    public Fluid getFlowing() {
        return BOPFluids.FLOWING_BOP_ORIGIN_VALLEY_WATER;
    }

    public Fluid getSource() {
        return BOPFluids.STILL_BOP_ORIGIN_VALLEY_WATER;
    }

    public Item getBucket() {
        return BOPItems.BOP_ORIGIN_VALLEY_WATER_BUCKET;
    }

    public BlockState createLegacyBlock(FluidState p_204527_1_) {
        return BOPBlocks.BOP_ORIGIN_VALLEY_WATER.defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
    }

    @Override
    protected FluidAttributes createAttributes() {
        return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow"))
                .translationKey("block.arfo.bop_origin_valley_water")
                .color(0xff0E31FF)
    ...
    public static class Flowing extends BopOriginValleyWater {
    ...
    public static class Source extends BopOriginValleyWater {
