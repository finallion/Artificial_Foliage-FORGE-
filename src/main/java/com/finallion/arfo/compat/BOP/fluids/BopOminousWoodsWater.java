...
public abstract class BopOminousWoodsWater extends ARFOWater {
    ...
    public BlockState createLegacyBlock(FluidState p_204527_1_) {
        return BOPBlocks.BOP_OMINOUS_WOODS_WATER.defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
    }

    @Override
    protected FluidAttributes createAttributes() {
        return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow"))
                .translationKey("block.arfo.bop_ominous_woods_water")
                .color(0xff312346)
    ...
    public static class Source extends BopOminousWoodsWater {
