...
public abstract class BopMysticGroveWater extends ARFOWater {

    public Fluid getFlowing() {
        return BOPFluids.FLOWING_BOP_MYSTIC_GROVE_WATER;
    }

    public Fluid getSource() {
        return BOPFluids.STILL_BOP_MYSTIC_GROVE_WATER;
    }

    public Item getBucket() {
        return BOPItems.BOP_MYSTIC_GROVE_WATER_BUCKET;
    }

    public BlockState createLegacyBlock(FluidState p_204527_1_) {
        return BOPBlocks.BOP_MYSTIC_GROVE_WATER.defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
    }

    @Override
    protected FluidAttributes createAttributes() {
        return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow"))
                .translationKey("block.arfo.bop_mystic_grove_water")
                .color(0xff9C3FE4)
    ...
    public static class Flowing extends BopMysticGroveWater {
    ...
    public static class Source extends BopMysticGroveWater {
