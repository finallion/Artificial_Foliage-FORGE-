...
public abstract class BopWastelandWater extends ARFOWater {

    public Fluid getFlowing() {
        return BOPFluids.FLOWING_BOP_WASTELAND_WATER;
    }

    public Fluid getSource() {
        return BOPFluids.STILL_BOP_WASTELAND_WATER;
    }

    public Item getBucket() {
        return BOPItems.BOP_WASTELAND_WATER_BUCKET;
    }

    public BlockState createLegacyBlock(FluidState p_204527_1_) {
        return BOPBlocks.BOP_WASTELAND_WATER.defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
    }

    @Override
    protected FluidAttributes createAttributes() {
        return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow"))
                .translationKey("block.arfo.bop_wasteland_water")
                .color(0xff433721)
    ...
    public static class Flowing extends BopWastelandWater {
    ...
    public static class Source extends BopWastelandWater {
