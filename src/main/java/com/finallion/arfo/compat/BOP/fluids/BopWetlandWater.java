...
public abstract class BopWetlandWater extends ARFOWater {
    ...
    public BlockState createLegacyBlock(FluidState p_204527_1_) {
        return BOPBlocks.BOP_WETLAND_WATER.defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
    }

    @Override
    protected FluidAttributes createAttributes() {
        return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow"))
                .translationKey("block.arfo.bop_wetland_water")
                .color(0xff272179)
    ...
    public static class Source extends BopWetlandWater {
