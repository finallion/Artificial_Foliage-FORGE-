...
public abstract class CliffsWater extends ARFOWater {
    ...
    public BlockState createLegacyBlock(FluidState p_204527_1_) {
        return TraverseBlocks.TRAVERSE_CLIFFS_WATER.defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
    }

    @Override
    protected FluidAttributes createAttributes() {
        return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow"))
                .translationKey("block.arfo.traverse_cliffs_water")
                .color(0xff3F76E4)
    ...
    public static class Source extends CliffsWater {
