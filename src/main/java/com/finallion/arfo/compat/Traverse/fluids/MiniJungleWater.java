...
public abstract class MiniJungleWater extends ARFOWater {
    ...
    public BlockState createLegacyBlock(FluidState p_204527_1_) {
        return TraverseBlocks.TRAVERSE_MINI_JUNGLE_WATER.defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
    }

    @Override
    protected FluidAttributes createAttributes() {
        return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow"))
                .translationKey("block.arfo.traverse_mini_jungle_water")
                .color(0xff003320)
    ...
    public static class Source extends MiniJungleWater {
